...
import models.Televisors;
import models.TelevisorsBuilder;
...
/********** Тест с BUIILDER + PageElements + Matcher + AAA + POM **********/
public class TelevisorsProductPage7_BUILDER_Test extends BaseTest {
  ...
  public void selectedProduct_Is_LedSamsungQE75Q950TSUXRUGrey() {
    ...
    TelevisorsBuilder builder = new TelevisorsBuilder(new Company("Samsung"));// Производитель
    Televisors televisors = builder.build(); // Создание объекта

    // 2. Act
    TelevisorsProductPage televisorsProductPage = getProductPage(televisors, minDiagonal, maxDiagonal, screenRefreshRate, led);
  ...
  public TelevisorsProductPage getProductPage(Televisors televisors,  String minDiagonal, String maxDiagonal, String screenRefreshRate, String led) {
    ...
    // Установка фильтра "Производитель" JB
    televisorsPage.chbxCompanyClick(televisors.getCompany().getCompany());
