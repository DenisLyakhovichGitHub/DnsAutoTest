...
/********** Тест с VO + PageElements + Matcher + AAA + POM **********/
public class TelevisorsProductPage5_VO_Test extends BaseTest {
  ...
  public void selectedProduct_Is_LedSamsungQE75Q950TSUXRUGrey() {
    ...
    TelevisorsVO televisorsVO = new TelevisorsVO(
        new Company(company)
    );

    // 2. Act
    TelevisorsProductPage televisorsProductPage = getProductPage(televisorsVO, minDiagonal, maxDiagonal, screenRefreshRate, led);
  ...
  public TelevisorsProductPage getProductPage(TelevisorsVO televisorsVO,  String minDiagonal, String maxDiagonal, String screenRefreshRate, String led) {
    ...
    // Установка фильтра "Производитель" VO
    televisorsPage.chbxCompanyClick(televisorsVO.getCompany().getCompany());
