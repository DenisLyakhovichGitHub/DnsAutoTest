...
/********** Тест с JB + PageElements + Matcher + AAA + POM **********/
public class TelevisorsProductPage6_JB_Test extends BaseTest {
  @Test
  // Проверка
  public void selectedProduct_Is_LedSamsungQE75Q950TSUXRUGrey() {
    ...
    TelevisorsJB smartphoneJB = new TelevisorsJB( "Samsung");

    // 2. Act
    TelevisorsProductPage televisorsProductPage = getProductPage(smartphoneJB, minDiagonal, maxDiagonal, screenRefreshRate, led);
  ...
  public TelevisorsProductPage getProductPage(TelevisorsJB smartphoneJB,  String minDiagonal, String maxDiagonal, String screenRefreshRate, String led) {
    ...
    televisorsPage.chbxCompanyClick(smartphoneJB.getCompany());
